...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> manejarErroresValidacion(MethodArgumentNotValidException ex) {
        ...
        // Mapeo de cada campo fallido con su respectivo mensaje
    ...
    // Captura de errores de lógica de negocio personalizados
    ...
    // Captura genérica de errores internos del servidor
    ...
    public ResponseEntity<ErrorResponse> manejarCredencialesInvalidas(CredencialesInvalidadException ex) {
        ErrorResponse error = new ErrorResponse(
